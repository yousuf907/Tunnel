...
if __name__ == "__main__":
    ...
    if cfg.set == "ninco":
        from feature_extractor_ninco import Feature_Extractor ## For VGG architectures and NINCO OOD dataset
    elif cfg.set == "imagenet10":
        from feature_extractor_class_samples import Feature_Extractor ## For VGG and ID dataset for varied classes and samples experiments
    else:
        from feature_extractor_vgg import Feature_Extractor ## For VGG architectures and all other experiments
