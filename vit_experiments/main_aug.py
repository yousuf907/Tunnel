...
from datasets import build_dataset, filter_by_class ### with augmentation
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='tvit_tiny_patch8', type=str, metavar='MODEL',
    ...
    parser.set_defaults(repeated_aug=True) # Aug
