...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        nb_classes = 100
    elif args.data_set == 'IMNET': # ImageNet-100
        args.data_path='/data/datasets/ImageNet-100'
        root = os.path.join(args.data_path, 'train' if is_train else 'val')
        dataset = datasets.ImageFolder(root, transform=transform)
        nb_classes = 100
    elif args.data_set == 'IMNETR':
        args.data_path='/home/yousuf/dualprompt-pytorch/data/imagenet-r'
        root = os.path.join(args.data_path, 'train' if is_train else 'test')
        dataset = datasets.ImageFolder(root, transform=transform)
        nb_classes = 200 #200
    elif args.data_set == 'NINCO':
        args.data_path='/home/yousuf/NINCO/NINCO_OOD_classes'
        ...
        args.data_path='/home/yousuf/cub200'
    ...
    #elif args.data_set == 'MIT67': # Also known as Scene67
    ...
    #    nb_classes = 67
        ...
        if is_train:
            ...
            split = 'test'
        dataset = datasets.STL10(args.data_path, split=split, download=False, transform=transform)
        nb_classes = 10
